"""
Django settings for sampelpro project.
...
SECRET_KEY = 'sxi!nfs)f7ipcbcm@ya#f8g8exe8pijwbao_2712(_c2(6c^g)'
...
# mysql connection
def CONNECTION():
    # cnn = mysql.connect(host="localhost",user='root',password="root",database="collegeweb")
